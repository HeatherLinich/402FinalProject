<?php
/**
 * catalogue.php - catalogue viewer class for 402 framework
 */

require_once VIEW_DIR."html_builder.php";

/**
 * load and initialise Catalogue Viewer class for 402 framework
 */
class CatalogueViewer extends BuildHTML {
	...
	$page_title_attributes = array("id" => "defCol1", "title"=>"page title");
	...
	$page_link_attributes = array("id" => "defCol2", "title"=>"click to view full page");
	...
	$page_link_cell = $page_link_start.$link_start."Definition".$link_end.$cell_end;
	self::$book_content .= $page_row_start.$page_title_cell.$page_link_cell.$row_end;
	}
