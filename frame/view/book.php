...
class BookViewer extends BuildHTML {
	...
	$headers = array("Book Title","Author","Publisher");
	...
	$page_title_attributes = array("id" => "defCol2", "title"=>"page title");
	...
	$page_desc_attributes = array("id" => "defCol2", "title"=>"page description");
	...
	$page_text_attributes = array("id" => "defCol2", "title"=>"a snippet of page text");
	...
	self::$book_content .= $page_row_start.$page_title_cell.$page_desc_cell.$page_text_cell.$row_end;
	}
